...
const LatestNews: React.FC<ILatestNewsProps> = (props: ILatestNewsProps) => {
    ...
    const handleToggleCommentPart = (index: number) => {
        const updatedCommentVisible = [...commentVisible];
        updatedCommentVisible[index] = !updatedCommentVisible[index];
                                   ...
                                   <a href={item.Link}> <button className={styles.CB_link}>
                                    ...
                                    <div className={styles.CB_reactions}>
                                        ...
                                        <div style={{paddingRight:'5px'}}>   
                                            <button className={styles.CB_reactions_BTN}  onClick={() => handleToggleCommentPart(index)}>
